...
public class CorridorNode : BSPNode
{
    ...
    public CorridorNode(BSPNode node1, BSPNode node2, int corridorWidth) : base(null)
    {
    ...
    private void ProcessRoomInRelationRightOrLeft(BSPNode structure1, BSPNode structure2)
    {
        ...
        List<BSPNode> leftStructureChildren = StructureHelper.TraverseGraphToExtractLowestLeafes(structure1);
        BSPNode rightStructure = null;
        List<BSPNode> rightStructureChildren = StructureHelper.TraverseGraphToExtractLowestLeafes(structure2);
    ...
    private void ProcessRoomInRelationUpOrDown(BSPNode structure1, BSPNode structure2)
    {
        ...
        List<BSPNode> structureBottmChildren = StructureHelper.TraverseGraphToExtractLowestLeafes(structure1);
        BSPNode topStructure = null;
        List<BSPNode> structureAboveChildren = StructureHelper.TraverseGraphToExtractLowestLeafes(structure2);
